...
<!--        <img alt="/" class="h-full w-auto" src="@/assets/images/snowflake-text001.png"/>-->
    ...
    <div class="container-box relative z-1">
      <div class="container-width logo-container">
        ...
        <div class="flex items-center justify-center flex-1">
          <img alt="" class="w-9/12" src="@/assets/images/yflogo.pngig"/>
        </div>
      </div>
    </div>
    <div class="h-20"></div>
    ...
    <div v-if="gbTb==1">
      ...
      <div class="container-box relative z-1">
        <div class="container-width">
          ...
          <div class="h-1"></div>
          <div
              :style="getBgStyle(experimentalDetectionData.downContent,experimentalDetectionData.downContentRef,-5)"
      ...
      <div class="container-box relative z-1">
        <div class="container-width">
          ...
          <div class="h-1"></div>
          <div
              :style="getBgStyle(experimentalDetectionData.bulkiness,experimentalDetectionData.bulkinessRef,-5)"
              class="w-full h-[6px] rounded-[6px]"
          ></div>
        </div>
      </div>
